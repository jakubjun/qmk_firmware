...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [ALPHAS__ALPHAS_0] = LAYOUT(
            ...
            KC_Z, KC_X, KC_M, KC_C, KC_V,      KC_K, KC_L, KC_COMM, KC_DOT, KC_SLSH,
                            MO(MODS__ARROWS_2), MO(MOUSE__WM_GO_TO_6),      KC_SPC, MO(SYMBOLS__NUMPAD_1)
    ),
    ...
    [SYMBOLS__NUMPAD_1] = LAYOUT(
            ...
            KC_LBRC, KC_RBRC, KC_HASH, KC_LCBR, KC_RCBR,    KC_CAPS, KC_1, KC_2, KC_3, KC_PPLS,
                                       MO(WM_SPLIT__WM_NAV_3), KC_LCTL,      KC_NO, KC_NO
    ),
    ...
    [MODS__ARROWS_2] = LAYOUT(
            ...
            LGUI(KC_SPC), LGUI(KC_M), LGUI(KC_N), LGUI(KC_MINS), SGUI(KC_MINS),  KC_TAB, KC_PGDN, KC_PGUP, KC_ENT, KC_TILD,
                                                                KC_NO, KC_NO,  KC_LSFT, MO(WM_SPLIT__WM_NAV_3)
    ),
    ...
    [WM_SPLIT__WM_NAV_3] = LAYOUT(
            ...
            KC_NO, KC_NO, KC_NO, SGUI(KC_Q), SGUI(KC_R),                  LGUI(KC_D), LGUI(KC_ENT), KC_NO, KC_NO, KC_NO,
                                         KC_NO, MO(BOOT__WM_MOVE_4),                  MO(BOOT__WM_MOVE_4), KC_NO
    ),
...
/*     rgblight_setrgb_at(177, 0, 177, 0); */
/*     rgblight_setrgb_at(177, 10, 30, 1); */
/* } */
...
void housekeeping_task_user(void) {
    ...
    switch (get_highest_layer(layer_state | default_layer_state)) {
        case ALPHAS__ALPHAS_0: // 00
            ...
            break;
        case SYMBOLS__NUMPAD_1: // 01
            rgblight_setrgb_at(RGB_BLACK, 0);
            rgblight_setrgb_at(30,0,0, 1);
            break;
        case MODS__ARROWS_2: // 02
            rgblight_setrgb_at(RGB_BLACK, 0);
            rgblight_setrgb_at(0,30,0, 1);
            break;
        case WM_SPLIT__WM_NAV_3: // 03
            rgblight_setrgb_at(RGB_BLACK, 0);
            rgblight_setrgb_at(0,0,30, 1);
            break;
        case BOOT__WM_MOVE_4: // 10
            rgblight_setrgb_at(30,0,0, 0);
            rgblight_setrgb_at(RGB_BLACK, 1);
            break;
        case NO__F_KEYS_5: // 11
            rgblight_setrgb_at(30,0,0, 0);
            rgblight_setrgb_at(30,0,0, 1);
            break;
        case MOUSE__WM_GO_TO_6: // 12
            rgblight_setrgb_at(30,0,0, 0);
            rgblight_setrgb_at(0,30,0, 1);
            break;
        case RGB__WM_MOVE_TO_7: // 13
            rgblight_setrgb_at(30,0,0, 0);
            rgblight_setrgb_at(0,0,30, 1);
            break;
        case NO__VIM_8: // 13

...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [3] = LAYOUT(
            ...
            KC_NO, KC_NO, KC_NO, SGUI(KC_Q), SGUI(KC_R),                  LGUI(KC_D), LGUI(KC_ENT), KC_NO, KC_NO, KC_NO,
                                         KC_NO, MO(4),                  MO(4), KC_NO
    ),

    [4] = LAYOUT(
            QK_BOOT, KC_NO, KC_NO, KC_NO, KC_NO,         KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
            KC_NO, KC_NO, KC_NO, MO(8), KC_NO,           SGUI(KC_J), SGUI(KC_K), SGUI(KC_L), SGUI(KC_SCLN), KC_NO,
    ...
    [6] = LAYOUT(
            LCTL(KC_BSPC), KC_NO, KC_NO, KC_WH_U, KC_NO,         KC_NO, LGUI(KC_7), LGUI(KC_8), LGUI(KC_9), KC_NO,
            KC_BSPC, KC_BTN3, KC_BTN2, KC_BTN1, LGUI(KC_MINS),   KC_NO, LGUI(KC_4), LGUI(KC_5), LGUI(KC_6), LGUI(KC_0),
            TG(6), KC_NO, KC_NO, KC_WH_D, KC_NO,                 KC_NO, LGUI(KC_1), LGUI(KC_2), LGUI(KC_3), KC_NO,
                                 KC_NO, KC_NO,                 MO(5), MO(7)
    ),
    ...
    [8] = LAYOUT(
            KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,        KC_Q, KC_NO, KC_NO, KC_NO, KC_NO,
            KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
            KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
                                 KC_NO, KC_NO,        KC_NO, KC_NO
    )
